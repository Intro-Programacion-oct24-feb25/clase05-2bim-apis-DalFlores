...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        int multiplicacion = OperadorTres.obtenerMultiplicacion(valorA, 
                                                                valorB);
        /* Importamos funciones de los otros paquetes a un main el cual nos ayudara 
        a ejecutar las funciones que llamamos desde el main que son importadas a otros 
